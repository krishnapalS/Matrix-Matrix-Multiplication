...
#SBATCH -J matmul_test

# Standard out and Standard Error output files
#SBATCH -o matmul_test.output
#SBATCH -e matmul_test_error.output
...
nvcc matrix_mul_without_tiling.cu -lcudart -o matmul

# Run the omp executable
srun matmul in_a.txt in_b.txt 4 5 4
